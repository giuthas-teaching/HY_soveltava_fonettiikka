...
\author{Pertti Palo} \date{23. Huhtikuuta 2021}
...
\frame{\frametitle{Splinit II: Lähempi esimerkki}
  \hspace*{-.5cm}
  \centering
  \includegraphics[width=.7\textwidth]{uti_traced}
}

\frame{\frametitle{Splinit III: Analyysimenetelmiä}
  \hspace*{-.45cm}
  \centering
...
\frame{\frametitle{Kirjallisuutta ja kiitokset}
  \nocite{AlTamimi:TCG:2021,Dahlgren:SLS:2021}
