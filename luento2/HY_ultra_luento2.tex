...
The University of Alberta respectfully acknowledges that we are located on
Treaty 6 territory, a traditional gathering place for diverse Indigenous
peoples including the Cree, Blackfoot, Métis, Nakota Sioux, Iroquois, Dene,
Ojibway/ Saulteaux/Anishinaabe, Inuit, and many others whose histories,
...
\frame{\frametitle{Edellisen kerran sisältöä}
  ...
  \item 1. Luento: Video 
    ...
    \cite{PrestonEtAl-UltrasoundImagesTongue-2017}
...
\frame{\frametitle{Lueskeltavaa}
  ...
  Ala tarvitsee lisää innokkaita jatko-opiskelijoita!
  \begin{itemize}
...
\frame{\frametitle{Esimerkkiprojekti 4: Kurkunpään liikkeitä}
  ...
  \hspace*{-.5cm}
  \begin{center}
    \includegraphics[width=1\textwidth]{figures/larynx_probe_placement-a-b-c.png}
  \end{center}

  {\scriptsize Scott R. Moisik, Hua Lin and John H. Esling (2014). A
...
\frame{\frametitle{Esimerkkiprojekti 4: Kurkunpään liikkeitä}
  ...
  \hspace*{-.5cm}
  \begin{center}
    \includegraphics[width=1\textwidth]{figures/larynx_probe_placement-b-c-d.png}
  \end{center}
...
\frame{\frametitle{Esimerkkiprojekti 4: Kurkunpään liikkeitä}
  ...
  \begin{center}
    \includegraphics[width=\textwidth]{figures/optic_flow.png}
  \end{center}


  {\scriptsize
    Moisik, S. R., Esling, J. H., Bird, S., \& Lin, H. (2011). Evaluating
...
\begin{itemize}
  \item Samat rakenteet, erilainen anturi $\rightarrow$ erilainen kuva.
\end{itemize}
...
\frame{\frametitle{Viitteet, ja lukemista}
  \nocite{Al-TamimiPalo-TongueContoursGuttural-2025,
  DahlgrenPalo-StudyingLanguagespecificCoarticulatory-2025,
  Palo-MeasuringPrespeechArticulation-2019,
